package me.brook.selection.tools.dyn4j;
...
public class SimulationBody extends Body {
	...
	public BodyFixture addFixture(Convex convex) {
		BodyFixture bf =  super.addFixture(convex);
		bf.setFilter(new CollisionFilter());
		
		return bf;
	}
	
	@Override
	public CollisionBody<BodyFixture> addFixture(BodyFixture fixture) {
		fixture.setFilter(new CollisionFilter());
		CollisionBody<BodyFixture> coll =  super.addFixture(fixture);
	...
	public class CollisionFilter implements Filter {
		...
		private SimulationBody sb = SimulationBody.this;
...
//			return true;
			...
			CollisionFilter cf = (CollisionFilter) filter;
			
			return sb.label.equals("hasCollision") || cf.sb.label.equals("hasCollision");
		}
